...
class BigFloat {
 ...
 public:
  ...
  BigFloat(long long Num) { *this = Num; };
  ...
  BigFloat &operator=(long long Num);
  ...
  friend BigFloat operator/(const BigFloat &left, const int &int_right);
  friend BigFloat operator/(const BigFloat &left, const double &double_right);
  static BigFloat PrecDiv(const BigFloat &left, const BigFloat &right,
                          int div_precision);
  static BigFloat PrecDiv(const BigFloat &left, const int &int_right,
                          int div_precision);
  static BigFloat PrecDiv(const BigFloat &left, const double &double_right,
                          int div_precision);
  ...
  void SetPrecision(
      int prec);  // Approximate number or Increase number decimals

  void LeadTrim();   // Remove number leading zeros, utilized by Operations
                     // without sign
